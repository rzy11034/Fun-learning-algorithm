...
begin
  _Num1.Clear;
  _Num1.Clear;
  __StringToNumList(num1, _Num1);
  __StringToNumList(num2, _Num2);
end;
...
function TMultiply.__NumToString(nums: TArrayList_int): string;
var
  sb: TStringBuilder;
  i: integer;
begin
...
begin
  Self.Len := len;
  Self.Pow := pow;
  Self.Nums := TArrayList_int.Create(len);
end;
